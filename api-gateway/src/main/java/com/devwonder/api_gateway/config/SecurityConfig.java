        ...
        public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
                return http
                                ...
                                .authorizeExchange(exchanges -> exchanges
                                                ...
                                                // Product Service - GET public, POST/PUT/DELETE require ADMIN or
                                                // specific
                                                // permissions
                                                .pathMatchers(HttpMethod.GET, "/api/product/**").permitAll()
                                                .pathMatchers("/api/product-serials/*/exists").permitAll() // For
                                                                                                           // validation
                                                ...
                                                .pathMatchers("/api/user/reseller/*/exists").permitAll() // For
                                                                                                         // validation
                                                ...
                                                // Warranty Service - ADMIN and DEALER can manage, CUSTOMER can view
                                                // their own
