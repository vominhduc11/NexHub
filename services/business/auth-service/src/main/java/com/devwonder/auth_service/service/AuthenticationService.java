...
public class AuthenticationService {
        ...
        public LoginResponse login(LoginRequest request) {
                ...
                // Check if account can login (status and deletion check)
                if (!account.canLogin()) {
                        log.warn("Account {} cannot login - status: {}, deleted: {}", 
                                account.getId(), account.getStatus(), account.getDeletedAt() != null);
                        throw new AuthenticationException("Account is not active or has been deactivated");
                }
