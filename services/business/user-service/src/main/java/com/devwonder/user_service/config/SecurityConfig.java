...
public class SecurityConfig extends BaseSecurityConfig {
    ...
    protected void configureServiceEndpoints(AuthorizeHttpRequestsConfigurer<org.springframework.security.config.annotation.web.builders.HttpSecurity>.AuthorizationManagerRequestMatcherRegistry auth) {
        auth
            ...
            .requestMatchers(HttpMethod.GET, "/user/reseller/deleted").access(gatewayHeaderRequired())
            ...
            .requestMatchers(HttpMethod.PUT, "/user/reseller/*/approve").access(gatewayHeaderRequired())
            .requestMatchers(HttpMethod.PUT, "/user/reseller/*/reject").access(gatewayHeaderRequired())
